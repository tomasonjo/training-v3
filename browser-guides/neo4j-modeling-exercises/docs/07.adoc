...
image::Ex7_Model.png[Ex7_Model,800]
...
[.thumb]
image::Ex7_AddSpecificRelationships.png[Ex7_AddSpecificRelationships,width=600]
...
[.thumb]
image::Ex7_FindFlightsJan3.png[Ex7_FindFlightsJan3,width=300]
