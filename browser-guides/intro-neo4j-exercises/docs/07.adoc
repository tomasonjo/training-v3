...
[.thumb]
image::UsingLists.png[UsingLists,width=600]
...
The result returned should be:
[.thumb]
image::ActorsWithMoreThan5Movies1.png[ActorsWithMoreThan5Movies1,width=700]
...
[.thumb]
image::ActorsWithMoreThan5Movies2.png[ActorsWithMoreThan5Movies2,width=600]
