...
image::AfterExercise8.png[After exercise 8,300, role=left]
...
[.thumb]
image::CreateForrestGump2.png[CreateForrestGump2,width=700]
...
[.thumb]
image::MergeForrestGump.png[MergeForrestGump,width=700]
...
[.thumb]
image::MergeProduction.png[MergeProduction,width=700]
...
[.thumb]
image::AddCompany.png[AddCompany,width=700]
...
[.thumb]
image::AddOlderMovieLabelToForrestGump.png[AddOlderMovieLabelToForrestGump,width=700]
