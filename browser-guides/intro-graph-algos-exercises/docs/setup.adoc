...
:setup-guides-dir: ../../../modules/setup-guides/docs
...
image:PluginsAppInstalled.png[PluginsAppInstalled,width=400]
...
image:YelpLoaded.png[YelpLoaded,width=150]
...
image:NEulerInstalled.png[NEulerInstalled,width=800]
