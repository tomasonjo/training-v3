...
image::AfterExercise1.png[Empty_database,width=300,role=left]
...
[.thumb]
image::Ex2_LoadFLights.png[Ex2_LoadFlights,width=600]
...
* Returns the `Airport` nodes and the `outgoing` count in descending order by `Connections`.
* Limits the number of airports returned to 10.

The result returned should be:

[.thumb]
image::Ex2_PopularAirports.png[Ex2_PopularAirports,width=400]
...
[.thumb]
image::Ex2_IncomingConnections.png[Ex2_IncomingConnections,width=400]
...
[.thumb]
image::Ex2_LASIncomingConnections.png[Ex2_LASIncomingConnections,width=600]
...
[.thumb]
image::Ex2_LASToLAXConnections.png[Ex2_LASToLAXConnections,width=600]
...
[.thumb]
image::Ex2_WN1016.png[Ex2_WN1016,width=600]
