...
[.thumb]
image::CreateIndex.png[CreateIndex,width=500]
...
*Note:* In Neo4j 4.2 and later you can use `SHOW INDEXES`.
...
[.thumb]
image::DropIndex.png[DropIndex,width=500]
...
[.thumb]
image::CreateFTIndex.png[CreateFTIndex,width=500]
...
[.thumb]
image::ViewIndexes2.png[ViewIndexes2,width=800]
...
[.thumb]
image::DropFTIndex.png[DropFTIndex,width=500]
