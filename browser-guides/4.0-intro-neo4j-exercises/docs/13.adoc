...
image::AfterExercise12.png[AfterExercise12,width=300]
...
[.thumb]
image::CreatePersonNameUnique.png[CreatePersonNameUnique,width=400]
...
[.thumb]
image::CreateTomHanksFailed.png[CreateTomHanksFailed,width=500]
...
[.thumb]
image::CreateBornExistsConstraintFailed.png[CreateBornExistsConstraintFailed,width=500]
...
[.thumb]
image::AddBornProperty.png[AddBornProperty,width=500]
...
[.thumb]
image::AddBornExistsConstraint.png[AddBornExistsConstraint,width=500]
...
[.thumb]
image::CannotAddWithoutBorn.png[CannotAddWithoutBorn,width=500]
...
[.thumb]
image::CreateRolesConstraintExists.png[CreateRolesConstraintExists,width=500]
...
[.thumb]
image::CannotCreateActedInwithoutRoles.png[CannotCreateActedInwithoutRoles,width=600]
...
[.thumb]
image::AddNodeKey.png[AddNodeKey,width=500]
...
[.thumb]
image::AddedBackToTheFuture1985.png[AddedBackToTheFuture1985,width=500]
...
[.thumb]
image::AddedBackToTheFuture2018.png[AddedBackToTheFuture2018,width=500]
...
[.thumb]
image::AddBackToFutureFailed.png[AddBackToFutureFailed,width=500]
...
[.thumb]
image::listConstraints.png[listConstraints,width=600]

*Note:* In Neo4j 4.2 and later you can use `SHOW CONSTRAINTS`.
...
[.thumb]
image::dropConstraintRoles.png[dropConstraintRoles,width=500]
