...
[.thumb]
image::AtMost3MoviesPerActor.png[AtMost3MoviesPerActor,width=600]
...
[.thumb]
image::TopDirectorsAndReviewers.png[TopDirectorsAndReviewers,width=600]
...
The result returned should be:
[.thumb]
image::ActorsWithMoreThan5Movies1.png[ActorsWithMoreThan5Movies1,width=800]
...
*Note:* If you are using a Neo4j 4.1 or later database, you will see some additional values for the nodes that include the _identity_ and _labels_.
...
[.thumb]
image::ActorsWithMoreThan5Movies2.png[ActorsWithMoreThan5Movies2,width=500]
