...
image::AfterExercise10.png[AfterExercise10,width=300]
...
[.thumb]
image::DeleteHELPED.png[DeleteHELPED,width=500]
...
[.thumb]
image::ConfirmDeleteHELPED.png[ConfirmDeleteHELPED,width=500]
...
[.thumb]
image::DetachDelete.png[DetachDelete,width=500]
...
[.thumb]
image::NoForrestGump.png[NoForrestGump,width=500]
