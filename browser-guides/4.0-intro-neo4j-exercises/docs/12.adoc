...
image::AfterExercise11.png[AfterExercise11,width=300]
...
[.thumb]
image::CreateForrestGump2.png[CreateForrestGump2,width=600]
...
[.thumb]
image::MergeForrestGump.png[MergeForrestGump,width=600]
...
[.thumb]
image::MergeProduction.png[MergeProduction,width=600]
...
[.thumb]
image::AllForrestGumps.png[AllForrestGumps,width=600]
...
[.thumb]
image::AddCompany.png[AddCompany,width=600]
...
[.thumb]
image::AddOlderMovieLabelToForrestGump.png[AddOlderMovieLabelToForrestGump,width=600]
...
[.thumb]
image::MergeNodesAndRelationships.png[MergeNodesAndRelationships,width=500]
...
[.thumb]
image::MergeNodesAndRelationships2.png[MergeNodesAndRelationships2,width=500]
...
[.thumb]
image::FindPersonNodeBeforeDelete.png[FindPersonNodeBeforeDelete,width=600]
...
[.thumb]
image::DeletedExtraPerson.png[DeletedExtraPerson,width=500]
...
[.thumb]
image::ForrestGumpToDelete.png[ForrestGumpToDelete,width=600]
...
[.thumb]
image::DeletedExtraForrestGump.png[DeletedExtraForrestGump,width=500]
...
[.thumb]
image::AddDirectedToForrestGump.png[AddDirectedToForrestGump,width=500]
...
[.thumb]
image::ActedInForrestGump.png[ActedInForrestGump,width=500]
...
[.thumb]
image::SetActedRoles.png[SetActedRoles,width=500]
...
[.thumb]
image::VerifyRoleUpdates.png[VerifyRoleUpdates,width=600]
