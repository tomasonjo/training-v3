...
(function ($) {
  ...
  // 2020-05-22 - temporary default value to ease the migration from v2 to v3
...
;(function (c, a) {
  if (!a.__SV) {
    ...
    let src;
    if ("undefined" !== typeof MIXPANEL_CUSTOM_LIB_URL) {
      src = MIXPANEL_CUSTOM_LIB_URL
    } else {
      src = "//cdn4.mxpnl.com/libs/mixpanel-2-latest.min.js"
      if ("file:" === c.location.protocol) {
        if ("//cdn4.mxpnl.com/libs/mixpanel-2-latest.min.js".match(/^\/\//)) {
          src = "https://cdn4.mxpnl.com/libs/mixpanel-2-latest.min.js"
        }
      }
    }
    b.src = src;
