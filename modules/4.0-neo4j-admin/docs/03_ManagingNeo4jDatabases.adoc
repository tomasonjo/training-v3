...
When Neo4j is installed as a Debian package, the _neo4j_ service is enabled and the Neo4j instance is automatically started.
Other platforms do not start the Neo4j instance automatically.
...
----
systemctrl status neo4j
----

You should see something like this:

image::{imagedir}/systemctrl_status_initial.png[systemctrl_status_initial,width=600,align=center]
...
----
image::{imagedir}/add_var_run_neo4j.png[add_var_run_neo4j,width=600,align=center]
...
image::{imagedir}/disable_neo4j_service.png[disable_neo4j_service,width=600,align=center]
