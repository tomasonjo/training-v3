...
For your reference the default *default-neo4j.conf* file is available for your inspection so you can see what this file would look like on, for example, a Debian system.
