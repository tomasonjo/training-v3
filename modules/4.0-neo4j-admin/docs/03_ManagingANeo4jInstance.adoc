...
[.small]
--
When the instance is started, it creates a database directory named *neo4j* in the default location which is a directory under */var/lib/neo4j/data/databases*.
--
...
For example, on non-Debian and non RPM systems, the Neo4j log information is written to the *neo4j.log* file.
--
...
What commands are available for managing the Neo4j instance?
