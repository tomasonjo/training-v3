...
This feature is available with Neo4j Enterprise Edition.
...
== *Exercise 1: Setting up Neo4j Enterprise Edition for this course*
...
[%interactive]
- [ ] [.required-answer]#one, that will service two databases.#
- [ ] [.false-answer]#two, one Neo4j installation for each database.#
