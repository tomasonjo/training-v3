...
You want to retrieve the place and the country code for each *Place* in the smaller connected components so that you can talk to an appropriate person who handles the data collection for the country where you found some anomalies.
