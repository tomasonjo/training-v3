...
image::{imagedir}/DeleteLiamNeeson.png[DeleteLiamNeeson,width=600,align=center]

ifndef::backend-revealjs[]
And here is what the _Batman Begins_ node and its relationships now look like. There is only one actor, _Michael Caine_ connected to the movie.
endif::[]

image::{imagedir}/BatmanBeginsRelationships.png[BatmanBeginsRelationships,width=700,align=center]
