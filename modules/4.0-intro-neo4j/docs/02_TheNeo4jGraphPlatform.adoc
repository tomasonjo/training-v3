...
//*NEED TO UPDATE THIS VIDEO for 4.0*
...
Follow along with with this video (or instructor) to become familiar with common tasks in Neo4j Browser.
...
// Need Youtube URL here for embedding in PDF
