...
In addition,  Neo4j will ensure that the database instance is always up-to-date with the latest version of Neo4j.
...
[square]
* *cypher-shell* used to create, start, stop, and drop a particular database as well as query the "user" database.
