...
image::{imagedir}/CreateRatingExistenceConstraint.png[CreateRatingExistenceConstraint,width=900,align=center]
...
image::{imagedir}/ExistenceConstraintFailed.png[ExistenceConstraintFailed,width=1000,align=center]
...
image::{imagedir}/call_db_constraints.png[call_db_constraints,width=1000,align=center]
...
image::{imagedir}/NodeKeyCreationFailed.png[NodeKeyCreationFailed,width=1000,align=center]
