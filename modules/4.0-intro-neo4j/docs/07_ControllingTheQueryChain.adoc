...
image::{imagedir}/WITHAndUNWIND.png[WITHAndUNWIND,width=700,align=center]
...
image::{imagedir}/PopularActorsWithAtLeast5Movies.png[PopularActorsWithAtLeast5Movies,width=1100,align=center]
...
image::{imagedir}/CALLsubquery.png[CALLsubquery,width=900,align=center]
