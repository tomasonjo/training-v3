...
image::{imagedir}/CastList1.png[CastList1,width=900,align=center]
...
image::{imagedir}/NodeIsMap.png[NodeIsMap,width=900,align=center]
...
image::{imagedir}/MapProjection.png[MapProjection,width=900,align=center]
...
Reminder: Click next  twice to reveal the  two correct answer.
--
