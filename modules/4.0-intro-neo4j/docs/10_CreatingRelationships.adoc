...
image::{imagedir}/KatieHolmsRoles.png[KatieHolmsRoles,width=900,align=center]
...
image::{imagedir}/CreateNodeAndRelationship.png[CreateNodeAndRelationship,width=1000,align=center]
...
image::{imagedir}/AddRelationshipWithRoles.png[AddRelationshipWithRoles,width=1000,align=center]
...
image::{imagedir}/RemoveRoles.png[RemoveRoles,width=1000,align=center]
