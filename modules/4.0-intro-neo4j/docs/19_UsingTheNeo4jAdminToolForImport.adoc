...
image::{imagedir}/ImportCrimes1.png[ImportCrimes1,width=1200,align=center]
...
//[%interactive]
[none.answers]
- ◻️  [.answer]#Create the database.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#Ensure the database does not exist.#
- ◻️  [.answer]#Create the constraints in the database.#
- ◻️  [.answer]#Create the indexes in the database.#
...
//[%interactive]
[none.answers]
- ◻️  [.answer]#The products_header.csv file must have a field, _USE_LABEL_.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#The products_header.csv file must have a field, _:LABEL_.#
- ◻️  [.answer]#The products.csv file must have the label name in the corresponding _USE_LABEL_ column.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#The products.csv file must have the label name in corresponding the _:LABEL_ column.#
...
[ ] The products.csv file must have the label name in corresponding the _:LABEL_ column.
