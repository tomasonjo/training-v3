...
:toc: left
:toclevels: 3
:prevsecttitle: Controlling the Query Chain
:prevsect: 7
:currsect: 8
...
image::Duplication.png[Duplication,width=600,align=center]
...
image::DuplicationInCollection.png[DuplicationInCollection,width=800,align=center]
--
...
image::Ordering.png[Ordering,width=800,align=center]
--
...
image::Ordering2.png[Ordering2,width=400,align=center]
...
image::Limit.png[Limit,width=600,align=center]
--
