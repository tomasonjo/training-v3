...
image::{imagedir}/SetActorNameParameter.png[SetActorNameParameter,width=600,align=center]
...
[.is-half.left]
--
image::{imagedir}/UseParameter.png[UseParameter,width=800,align=center]
--
...
image::{imagedir}/TomCruiseParameter.png[TomCruiseParameter,width=800,align=center]
--
...
image::{imagedir}/SetAllParameters.png[SetAllParameters,width=500,align=center]
...
image::{imagedir}/TomCruiseAndTopGun.png[TomCruiseAndTopGun,width=1000,align=center]
...
image::{imagedir}/ViewParams.png[ViewParams,width=500,align=center]
...
image::{imagedir}/ActorYearParams.png[ActorYearParams,width=500,align=center]
...
image::{imagedir}/EXPLAIN.png[EXPLAIN,width=1200,align=center]
...
image::{imagedir}/EXPLAIN2.png[EXPLAIN2,width=1100,align=center]
...
image::{imagedir}/PROFILE1.png[PROFILE1,width=1300,align=center]
...
image::{imagedir}/PROFILE2.png[PROFILE2,width=1300,align=center]
...
image::{imagedir}/ROGUE1.png[ROGUE1,width=600,align=center]
...
image::{imagedir}/ROGUE2.png[ROGUE2,width=600,align=center]
...
image::{imagedir}/ListQueries1.png[ListQueries1,width=1200,align=center]
...
image::{imagedir}/ListQueries2.png[ListQueries2,width=800,align=center]
...
image::{imagedir}/ListQueries3.png[ListQueries3,width=800,align=center]
...
image::{imagedir}/ListQueries4.png[ListQueries4,width=1300,align=center]
...
- ◻️  [.answer]#ANALYZE#
- ◻️  [.answer]#EXPLAIN#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#PROFILE#
- ◻️  [.answer]#MONITOR#
endif::[]
...
[none.answers]
- ◻️  [.answer]#:set param#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#:param#
- ◻️  [.answer]#:set params#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#:params#
endif::[]
...
//[%interactive]
[none.answers]
- ◻️  [.fragment.check.ok]#✔️# [.answer]#You can close the result pane in Session A, if the query can be seen in Session B.#
- ◻️  [.answer]#You can close the result pane in Session A, if the query can no longer be seen in Session B.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#You can kill any running query seen in Session B.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#You can close the Neo4j Browser that is running Session A.#
endif::[]
