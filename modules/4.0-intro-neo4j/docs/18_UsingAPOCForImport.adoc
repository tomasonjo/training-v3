...
image::{imagedir}/APOCInstalled.png[APOCInstalled,width=900,align=center]
...
image::{imagedir}/ClearDatabase.png[ClearDatabase,width=900,align=center]
...
image::{imagedir}/APOCLOADProcedures.png[APOCLOADProcedures,width=1100,align=center]
...
image::{imagedir}/APOC-noRelationships.png[APOC-noRelationships,width=400,align=center]
...
image::{imagedir}/DoWhenAPOC.png[DoWhenAPOC,width=400,align=center]
...
image::{imagedir}/APOCPeriodicIterate.png[APOCPeriodicIterate,width=1300,align=center]
...
image::{imagedir}/ExamineJSONData.png[ExamineJSONData,width=1000,align=center]
...
image::{imagedir}/ExamineJSONDataKeys.png[ExamineJSONDataKeys,width=1300,align=center]
...
image::{imagedir}/SOQuestionData.png[SOQuestionData,width=1300,align=center]
...
image::{imagedir}/SOLoadedGraph.png[SOLoadedGraph,width=500,align=center]
...
[none.answers]
- ◻️  [.answer]#`apoc.batch()`.#
- ◻️  [.answer]#`apoc.transaction.batch()`.#
- ◻️  [.answer]#`apoc.iterate()`.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#`apoc.periodic.iterate()`.#
...
//[%interactive]
[none.answers]
- ◻️  [.answer]#Scheduling when a load should occur.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#Executing Cypher code when a condition is true and alternate Cypher code when the condition is false.#
- ◻️  [.answer]#An alternative to the MERGE clause.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#Profiling the execution of a query.#
...
//[%interactive]
[none.answers]
- ◻️  [.fragment.check.ok]#✔️# [.answer]#Drops all constraints in the graph.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#Drops all indexes in the graph.#
- ◻️  [.answer]#Removes all relationships in the graph.#
- ◻️  [.answer]#Removes all nodes in the graph.#
