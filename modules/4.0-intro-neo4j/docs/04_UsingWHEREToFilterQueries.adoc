...
image::{imagedir}/MoviesBetween2003And2004.png[MoviesBetween2003And2004,width=800,align=center]
...
image::{imagedir}/TestLabels.png[TestLabels,width=600,align=center]
--
...
image::{imagedir}/JackNicholsonMoviesWithTaglines.png[JackNicholsonMoviesWithTaglines,width=900,align=center]
...
image::{imagedir}/ActorsNamedMichael.png[ActorsNamedMichael,width=800,align=center]
...
image::{imagedir}/MatchTomsRegex.png[MatchTomsRegex,width=800,align=center]
...
image::{imagedir}/WroteMovies.png[WroteMovies,width=800,align=center]
...
image::{imagedir}/WroteMoviesNotDirected.png[WroteMoviesNotDirected,width=800, align=center]
...
image::{imagedir}/ExistsPattern.png[ExistsPattern,width=700,align=center]
...
image::{imagedir}/UsingIN.png[UsingIN,width=800,align=center]
...
image::{imagedir}/UsingINRoles.png[UsingINRoles,width=600,align=center]
...
//[%interactive]
[none.answers]
- ◻️  [.fragment.check.ok]#✔️# [.answer]#p#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#rel#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#m#
- ◻️  [.answer]#PRODUCED#
...
[none.answers]
- ◻️  [.answer]#CONTAINS#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#IN#
- ◻️  [.answer]#IS#
- ◻️  [.answer]#EQUALS#
...
//[%interactive]
[none.answers]
- ◻️  [.answer]#MATCH (p:Person)
                      WHERE  (p)-[:WROTE]-(m) AND (p)-[WROTE]-(m)
                      RETURN p.name, m.title#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#MATCH (p:Person)-[:ACTED_IN]->(m:Movie)
                         WHERE  (p)-[:WROTE]-(m)
                         RETURN p.name, m.title#
- ◻️  [.answer]#MATCH (p:Person)-[:ACTED_IN | WROTE]->(m:Movie)
                         RETURN p.name, m.title#
- ◻️  [.answer]#MATCH (p:Person)-[:ACTED_IN]->(m:Movie)<-[WROTE]-(p)
                      RETURN p.name, m.title#
...
[X] MATCH (p:Person)-[:ACTED_IN]->(m:Movie)
          WHERE  (p)-[:WROTE]-(m)
          RETURN p.name, m.title

[ ] MATCH (p:Person)-[:ACTED_IN | WROTE]->(m:Movie)
          RETURN p.name, m.title
...
[.title.has-green-background.has-puzzle-backround]
== Summary
