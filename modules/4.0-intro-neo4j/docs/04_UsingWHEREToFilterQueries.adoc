...
image::{imagedir}/JackNicholsonMoviesWithTaglines.png[JackNicholsonMoviesWithTaglines,width=1100,align=center]
...
image::{imagedir}/WroteMovies.png[WroteMovies,width=700,align=center]
--
...
image::{imagedir}/ExistsPattern.png[ExistsPattern,width=650,align=center]
--
...
image::{imagedir}/UsingINRoles.png[UsingINRoles,width=800,align=center]
