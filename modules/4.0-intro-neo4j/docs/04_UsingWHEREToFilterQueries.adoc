...
:slug: using-where-to-filter-queries
:doctype: book
:toc: left
:toclevels: 3
...
image::MoviesBetween2003And2004.png[MoviesBetween2003And2004,width=800,align=center]
...
image::TestLabels.png[TestLabels,width=600,align=center]
--
...
image::MatchTomsRegex.png[MatchTomsRegex,width=800,align=center]
...
image::WroteMovies.png[WroteMovies,width=700,align=center]
--
...
image::WroteMoviesNotDirected.png[WroteMoviesNotDirected,width=800, align=center]
--
...
image::ExistsPattern.png[ExistsPattern,width=650,align=center]
--
...
image::UsingIN.png[UsingIN,width=800,align=center]
--
...
image::UsingINRoles.png[UsingINRoles,width=800,align=center]
...
[.slide-title.has-green-background.has-puzzle-background]
== Summary
