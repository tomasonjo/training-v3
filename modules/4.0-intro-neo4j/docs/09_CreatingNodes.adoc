...
image::{imagedir}/SetFantasyLabel.png[SetFantasyLabel,width=800,align=center]
...
image::{imagedir}/RemoveActionLabel.png[RemoveActionLabel,width=700,align=center]
...
image::{imagedir}/AddReleasedMinutesProperties.png[AddReleasedMinutesProperties,width=800,align=center]
...
image::{imagedir}/PropertyKeysBatmanBegins.png[PropertyKeysBatmanBegins,width=800,align=center]
...
image::{imagedir}/AddAndUpdateProperties.png[AddAndUpdateProperties,width=900,align=center]
...
image::{imagedir}/RemoveProperties.png[RemoveProperties,width=800,align=center]
