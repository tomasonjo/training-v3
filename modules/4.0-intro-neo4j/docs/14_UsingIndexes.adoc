...
image::{imagedir}/CreateSingle-propertyIndex.png[CreateSingle-propertyIndex,width=1000,align=center]
...
image::{imagedir}/TwoStatements.png[TwoStatements,width=1200,align=center]
...
image::{imagedir}/CreateCompositeIndex.png[CreateCompositeIndex,width=1000,align=center]
...
image::{imagedir}/CreateFullTextIndex2.png[CreateFullTextIndex2,width=1300,align=center]
--
...
image::{imagedir}/ManagingIndexes1.png[ManagingIndexes1,width=1300,align=center]
...
image::{imagedir}/ManagingIndexes4.png[ManagingIndexes4,width=1300,align=center]
