...
[.center]
image::{imagedir}/REVIEWEDProperties.png[ReviewedProperties,width=900,align=center]
...
[.is-half.left]
--
image::{imagedir}/FollowersOfFollowersQueryTraversal.png[FollowersOfFollowersQueryTraversal,width=300,align=center]
--
...
image::{imagedir}/NodesInPathForFollowersOfJessicaFollowers.png[NodesInPathForFollowersOfJessicaFollowers,width=1000,align=center]
...
image::{imagedir}/TraversalInTwoDirections.png[TraversalInTwoDirections,width=1100,align=center]
...
image::{imagedir}/ReturnPath.png[ReturnPath,width=1100,align=center]
...
image::{imagedir}/ReturnRonHowardPaths.png[ReturnRonHowardPaths,width=800,align=center]
