...
image::call_db.PropertyKeys.png[call_db.PropertyKeys,width=700,align=center]
--
...
image::call_db.schema-relationships.png[call_db.schema-relationships,width=800,align=center]
...
image::MatrixRelationshipTypes.png[MatrixRelationshipTypes,width=900,align=center]
--
...
image::AngelaFollowers.png[AngelaFollowers,width=700,align=center]
--
...
image::TraversalInTwoDirections.png[TraversalInTwoDirections,width=1100,align=center]
--
