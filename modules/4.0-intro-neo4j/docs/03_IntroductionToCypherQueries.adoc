...
//[%interactive]
[none.answers]
- ◻️  [.answer]#`MATCH (c:Customer {customerName: 'ABCCO'}) RETURN c.BOUGHT.productName`#
- ◻️  [.answer]#`MATCH (:Customer 'ABCCO')-[:BOUGHT\]->(p:Product) RETURN p.productName`#
- ◻️  [.answer]#`[MATCH (p:Product)<-[:BOUGHT_BY\]-(:Customer 'ABCCO') RETURN p.productName`#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#`[MATCH (:Customer {customerName: 'ABCCO'})-[:BOUGHT\]->(p:Product) RETURN p.productName`#
endif::[]
