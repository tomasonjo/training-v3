...
image::{imagedir}/call_db.schema.visualization.png[call_db.schema.visualization,width=700,align=center]
...
image::{imagedir}/PersonNodes-graph.png[PersonNodes-graph,width=700, align=center]
--
...
image::{imagedir}/PersonNodes-table.png[PersonNodes-table,width=700,align=center]
...
image::{imagedir}/call_db.PropertyKeys.png[call_db.PropertyKeys,width=700,align=center]
...
image::{imagedir}/MatchPersonBorn1970.png[MatchPersonBorn1970,width=600, align=center]
...
image::{imagedir}/TwoPropertiesForFilter.png[TwoPropertiesForFilter,width=700,align=center]
...
image::{imagedir}/MatchPersonBorn1965.png[MatchPersonBorn1965,width=800,align=center]
...
image::{imagedir}/UsingAliases.png[UsingAliases,width=800,align=center]
...
image::{imagedir}/call_db.schema-relationships.png[call_db.schema-relationships,width=800,align=center]
...
image::{imagedir}/ActorsInMatrix.png[ActorsInMatrix,width=800,align=center]
...
image::{imagedir}/TomHanksActedDirected.png[TomHanksActedDirected,width=700,align=center]
...
image::{imagedir}/AnonymousMovieNode.png[AnonymousMovieNode,width=800,align=center]
...
image::{imagedir}/AllRelationshipsMatrix.png[AllRelationshipsMatrix,width=800,align=center]
...
image::{imagedir}/MatrixRelationshipTypes.png[MatrixRelationshipTypes,width=900,align=center]
...
image::{imagedir}/ReturnPersonRating65.png[ReturnPersonRating65,width=800,align=center]
...
image::{imagedir}/FollowsRelationships.png[FollowsRelationships,width=500,align=center]
...
image::{imagedir}/AngelaFollowers.png[AngelaFollowers,width=700,align=center]
--
...
[.is-half.right]
--
image::{imagedir}/AngelaFollowersQueryTraversal.png[AngelaFollowers,width=400,align=center]
--
...
image::{imagedir}/FollowedByAngela.png[FollowedByAngela,width=700,align=center]
...
image::{imagedir}/AngelaFromTo.png[AngelaFromTo,width=700,align=center]
--
...
[.is-half.right]
--
image::{imagedir}/AngelaConnectionsQueryTraversal.png[AngelaConnectionsQueryTraversal,width=400,align=center]
--
...
image::{imagedir}/FollowersOfJessicaFollowers.png[FollowersOfJessicaFollowers,width=800,align-center]
--
...
[.is-half.right]
--
image::{imagedir}/FollowersOfFollowersQueryTraversal.png[FollowersOfFollowersQueryTraversal,width=400,align=center]
--
...
image::{imagedir}/NodesInPathForFollowersOfJessicaFollowers.png[NodesInPathForFollowersOfJessicaFollowers,width=800,allign=center]
...
image::{imagedir}/TraversalInTwoDirections.png[TraversalInTwoDirections,width=800,align=center]
...
image::{imagedir}/ReturnPath.png[ReturnPath,width=700,align=center]
...
image::{imagedir}/ReturnRonHowardPaths.png[ReturnRonHowardPaths,width=700,align=center]
...
[none.answers]
- ◻️  [.answer]#`MATCH (n) RETURN n.Customer.email`#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#`MATCH (c:Customer) RETURN c.email`#
- ◻️  [.answer]#`MATCH (Customer) RETURN email`#
- ◻️  [.answer]#`MATCH (c) RETURN Customer.email`#
...
[none.answers]
- ◻️  [.answer]#`pass:[MATCH (c:Customer {customerName: 'ABCCO'}) RETURN c.BOUGHT.productName]`#
- ◻️  [.answer]#`pass:[MATCH (:Customer 'ABCCO')-[:BOUGHT\]->(p:Product) RETURN p.productName]`#
- ◻️  [.answer]#`pass:[MATCH (p:Product)<-[:BOUGHT_BY\]-(:Customer 'ABCCO') RETURN p.productName]`#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#`pass:[MATCH (:Customer {customerName: 'ABCCO'})-[:BOUGHT\]->(p:Product) RETURN p.productName]`#
...
[none.answers]
- ◻️  [.answer]#When you want to query the graph using a node label.#
- ◻️  [.answer]#When you specify a property value to match the query.#
- ◻️  [.fragment.check.ok]#✔️# [.answer]#When you want to use the node or relationship to return a value.#
- ◻️  [.answer]#When the query involves 2 types of nodes.#
