...
[.thumb]
image::InitialQueryWithoutParms.png[InitialQueryWithoutParms,width=800]
...
[.thumb]
image::SetYearParam.png[SetYearParam,width=400]
...
[.thumb]
image::SetTwoParameters.png[SetTwoParameters,width=400]
