...
[.thumb]
image::call_db.schema.png[call_db.schema,width=600]
...
[.thumb]
image::SpeedRacerWriters.png[SpeedRacerWriters,width=600]
...
[.thumb]
image::TomHanksMovies.png[TomHanksMovies,width=400]
...
[.thumb]
image::TomHanksRelationshipTypes.png[TomHanksRelationshipTypes,width=600]
...
[.thumb]
image::TomHanksRoles.png[TomHanksRoles,width=600]
