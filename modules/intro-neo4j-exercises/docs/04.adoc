...
image:InitialDatabase.png[InitialDatabase,300]
...
[.thumb]
image::TomCruiseMovies.png[TomCruiseMovies,width=600]
...
[.thumb]
image::SeventiesActors.png[SeventiesActors,width=600]
...
[.thumb]
image::MatrixYoungerActors.png[MatrixYoungerActors,width=600]
...
[.thumb]
image::MatchMovies2000.png[MatchMovies2000,width=400]
...
[.thumb]
image::MatchWritersWhere.png[MatchWritersWhere,width=600]
...
[.thumb]
image::NoYearBorn.png[NoYearBorn,width=400]
...
[.thumb]
image::RelationshipsWithRatings.png[RelationshipsWithRatings,width=500]
...
[.thumb]
image::ActorsNamedJames.png[ActorsNamedJames,width=500]
...
[.thumb]
image::ReviewsWithFun.png[ReviewsWithFun,width=600]
...
[.thumb]
image::ProducersThatAreNotDirectors.png[ProducersThatAreNotDirectors,width=600]
...
[.thumb]
image::ActorsAsDirectors.png[ActorsAsDirectors,width=500]
...
[.thumb]
image::MoviesInList.png[MoviesInList,width=400]
...
[.thumb]
image::RoleNameIsMovieName.png[RoleNameIsMovieName,width=400]
