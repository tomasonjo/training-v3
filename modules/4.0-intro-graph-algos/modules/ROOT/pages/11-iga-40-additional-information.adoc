...
* You can always  use Similarity algorithms or Cypher projects to infer a monopartite graph from a bipartate graph.
...
* Create and detach a read replica from the cluster and us that for analysis.
endif::[]
