...
[.thumb]
image::EXP.1.png[EXP.1,width=400]
...
Here we see that with the weighted variant of PageRank, the most popular places are Rio, Albania, and Tornio.
...
* Specify *Madrid* as the source node.
* Exclude *Madrid* from results
