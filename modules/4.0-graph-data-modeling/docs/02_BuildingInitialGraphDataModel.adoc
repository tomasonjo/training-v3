= Building the Initial Graph Data Model
...
== Steps: Building the initial data model
...
image::Entities.png[Entities,width=200,align=center]
...
[square]
* Stakeholders must agree upon name.
* Avoid names that could be construed as nouns (for example email).
* Neo4j has a limit of 16M (64k) relationship types in Enterprise Edition (16M in Community Edition).
...
image::DrWho.png[DrWho,width=300,align=center]
...
=== How much fanout with a node have?

image::Fanout.png[Fanout,width=300,align=center]
...
image::Exercise3Solution.png[Exercise3Solution,width=300,align=center]
...
So thus far, you have defined the entities and relationships for the BOM application.
...
image::SampleDataBOM.png[SampleDataBOM,width=500,align=center]
...
image::TestModel1.png[TestModel1,width=500,align=center]
...
image::TestModel2.png[TestModel2,width=500,align=center]
...
image::TestModel3.png[TestModel3,width=500,align=center]
...
image::TestModel4.png[TestModel4,width=500,align=center]
...
[.is-half.right]
--
image::Scalable.png[Scalable,width=500,align=center]
--
