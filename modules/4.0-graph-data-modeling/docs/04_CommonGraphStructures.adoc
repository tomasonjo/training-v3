...
image::IntermediateNodesAfter.png[IntermediateNodesAfter,width=500,align=center]
...
image::MultipleStructures.png[MultipleStructurese,width=900,align=center]
...
[.notes]
--
At the top, we have a timeline tree, subdivides into years and months.
--

image::PartialTimeLineTree.png[PartialTimeLineTree,width=900,align=center]
...
image::PartialLinkedList.png[PartialLinkedList,width=900,align=center]
...
image::Ex4-Sol2.png[Ex4-Sol2,width=900,align=center]
