...
----
include::{partialsdir}/cypher/cypher-base.txt[tag=syntax]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-base.txt[tag=person]
----
...
video::Sz2C618QKN8[youtube,width=560,height=315,pdfwidth=100%]
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-match.txt[tag=simple]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-match.txt[tag=label]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-match.txt[tag=all]
----

[source,cypher]
----
include::{partialsdir}/cypher/cypher-match.txt[tag=person]
----
...
[NOTE]
When you specify a pattern for a `MATCH` clause, you should always specify a node label if possible.
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=single]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=with-label]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=multi]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=multi-with-label]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=person]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-filters.txt[tag=movie]
----
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-return.txt[tag=single]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-return.txt[tag=with-label]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-return.txt[tag=with-label-and-filters]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-return.txt[tag=multi]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-return.txt[tag=person]
----
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-aliases.txt[tag=single]
----

[NOTE]
If you want a heading to contain a space between strings, you must specify the alias with the back tick _`_ character, rather than a single or double quote character.
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-aliases.txt[tag=person]
----
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=syntax]
----
...
[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=single]
----

[source,cypher-syntax]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=multi]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=person-single]
----
...
[source.dont,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=dont]
----
--
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=person-multi]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=anonymous-node]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=anonymous-relationship-1]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=anonymous-relationship-2]
----

[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=anonymous-relationship-3]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=return-type]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=properties]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=pattern]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=pattern-reverse]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=any-direction]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=traversing]
----
...
[%unbreakable]
--
This query could also be modified to return each person along the path by specifying variables for the nodes and returning them.
In addition, you can assign a variable to the path and return the path as follows:

[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=traversing-including]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=direction]
----
...
[source,cypher]
----
include::{partialsdir}/cypher/cypher-relationships.txt[tag=best-practices]
----
--
