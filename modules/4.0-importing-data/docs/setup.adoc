= Setting up your Neo4j training environment for the course, Importing Data with Neo4j 4.x
:doctype: book
:toc: left
:toclevels: 4
:imagesdir: ../images
...
.. In a project, create a local graph (database (version 4.x or later) you will use for this course.
.. Start the graph.
...
include::{setup-guides-dir}/CreateDatabaseAura.adoc[]
...
If this query returns 0, then your database has been set up properly and you are ready to start the training.
