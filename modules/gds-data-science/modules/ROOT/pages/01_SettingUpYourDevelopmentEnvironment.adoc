...
=== Step 4: Open a Jupyter Notebook and connect to the Citations database
...
[square]
* Install Neo4j Desktop for learning Neo4j.
* Connecting to the Citations database with Neo4j Browser.
* Launching a Jupyter Notebook and connecting to the Citations database.
