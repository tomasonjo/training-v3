= Setting up your Neo4j training environment for the course, Implementing Graph Data Models in Neo4j 4.x
:doctype: book
:toc: left
:toclevels: 3
:imagesdir: ../images
...
https://r.neo4j.com/neo4j-implementing-modeling[https://r.neo4j.com/neo4j-implementing-modeling.zip]
