...
image::ProfileAfterRefactor.png[ProfileAfterRefactor,width=250, align=center]
...
ifndef::env-slides[]
////
image::FirstQueryAfterRefactor4.png[FirstQueryAfterRefactor4,width=450,align=center]
//endif::[]
...
ifndef::env-slides[]
image::OriginalSecondQueryAfterRefactor4.png[OriginalSecondQueryAfterRefactor4,width=450,align=center]
endif::[]
...
ifndef::env-slides[]
image::SecondQueryAfterRefactor4.png[SecondQueryAfterRefactor4,width=450,align=center]
endif::[]
...
ifndef::env-slides[]
image::LASToMDWBad.png[LASToMDWBad,width=350,align=center]
endif::[]
