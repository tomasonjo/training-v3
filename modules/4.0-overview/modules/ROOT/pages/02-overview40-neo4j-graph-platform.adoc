...
Functions and procedures from the  Neo4j 3.5 Graph Algorithms Library are officially supported by Neo4j as the Graph Data Science Library (GDS) in Neo4j 4.0.
...
- [x] APOC
- [ ] JGraph
- [x] Graph Algorithms (Neo4j 3.5) or Graph Data Science (Neo4j 4.0)
- [x] GraphQL
