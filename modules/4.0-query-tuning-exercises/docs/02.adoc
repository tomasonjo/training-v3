...
[.thumb]
image::sysinfo-dbsize.png[sysinfo-dbsize,width=500]
...
[.thumb]
image::listConfig.png[listConfig,width=800]
...
image::explain1.png[explain1,width=800]
...
image::explain2.png[explain2,width=800]
...
== Exercise 2.4: Are there any eager operators in this this second query? (Solution)
...
image::explain3.png[explain3,width=800]
...
image::explain4.png[explain4,width=800]
