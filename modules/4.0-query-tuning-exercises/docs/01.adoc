...
[.thumb]
image::params.png[params,width=800]
...
== Exercise 1.4: Are there any eager operators in this this second query? (Instructions)
...
== Exercise 1.4: Are there any eager operators in this this second query? (Solution)
...
[.thumb]
image::db.indexes.png[db.indexes,width=600]
...
[.thumb]
image::db.schema.png[db.schema,width=600]
...
[.thumb]
image::meta.stats[meta.stats,width=600]
...
[.thumb]
image::NoCountStore[NoCountStore,width=600]
...
[.thumb]
image::CountStore[CountStore,width=600]
