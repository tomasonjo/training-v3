...
[.thumb]
image::EX5.1.png[EX5.1,width=800]
...
[.thumb]
image::EX5.1A.png[EX5.1A,width=800]

== Exercise 5.2: Tune a query (Instructions)

1. Execute this Cypher code to return the names of directors of movies of each type of genre:
...
[.thumb]
image::EX5.2.png[EX5.2,width=800]
...
2. Rewrite this query to return collections with no duplication. Also make changes to it to reduce the number of rows in the execution plan.
...
[.thumb]
image::EX5.2A.png[EX5.2A,width=800]
...
[.thumb]
image::EX5.3.png[EX5.3,width=300]
...
[.thumb]
image::EX5.3A.png[EX5.3A,width=300]
...
ifdef::env-guide[]
pass:a[<a play-topic='{guides}/06.html'>Continue to Exercise 06</a>]
endif::[]
