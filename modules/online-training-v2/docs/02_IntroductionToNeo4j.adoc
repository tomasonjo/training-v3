...
:slug: 02-introneo-3-5-intro-neo4j
:doctype: book
:toc: left
:toclevels: 4
:imagesdir: ../images
...
[frame="none", cols="^.^,^.^,^.^"]
|===
a|image::Whiteboard1.png[Whiteboard1,width=300,align=center]
a|image::Whiteboard2.png[Whiteboard2,width=300,align=center]
a|image::Whiteboard3.png[Whiteboard3,width=300,align=center]
|===
