...
[.thumb]
image::{imagedir}/APOCinstalled.png[APOCinstalled,width=500]
...
[.thumb]
image::{imagedir}/ViewAPOCdataToLoad.png[ViewAPOCdataToLoad,width=500]
...
[.thumb]
image::{imagedir}/APOCLoadConstraints.png[APOCLoadConstraints,width=500]
...
[.thumb]
image::{imagedir}/APOCExecute.png[APOCExecute,width=600]
...
[.thumb]
image::{imagedir}/ClearedDB.png[ClearedDB,width=600]
