...
[.thumb]
image::SpeedRacerWriters.png[SpeedRacerWriters,width=500]
...
[.thumb]
image::TomHanksMovies.png[TomHanksMovies,width=800]
...
[.thumb]
image::TomHanksRelationshipTypes.png[TomHanksRelationshipTypes,width=700]
...
[.thumb]
image::TomHanksRoles.png[TomHanksRoles,width=700]
