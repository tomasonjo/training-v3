...
[.thumb]
image::{imagedir}/SpeedRacerWriters.png[SpeedRacerWriters,width=500]
...
[.thumb]
image::{imagedir}/TomHanksMovies.png[TomHanksMovies,width=600]
...
[.thumb]
image::{imagedir}/TomHanksRelationshipTypes.png[TomHanksRelationshipTypes,width=500]
...
[.thumb]
image::{imagedir}/TomHanksRoles.png[TomHanksRoles,width=600]
