...
[.thumb]
image::{imagedir}/ActorMovies.png[ActorMovies,width=500]
...
[.thumb]
image::{imagedir}/TomCruiseCoActors.png[TomCruiseCoActors,width=600]
...
[.thumb]
image::{imagedir}/CountReviews.png[CountReviews,width=600]
...
[.thumb]
image::{imagedir}/CountActorsWhoWorkedWithDirectors.png[CountActorsWhoWorkedWithDirectors,width=600]
...
[.thumb]
image::{imagedir}/CustomMap.png[CustomMap,width=500]
...
[.thumb]
image::{imagedir}/AgeCalculations.png[AgeCalculations,width=600]
