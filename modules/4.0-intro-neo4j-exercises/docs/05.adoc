...
[.thumb]
image::{imagedir}/GeneHackmanMoviesWithDirectorAndCoActors.png[GeneHackmanMoviesWithDirectorAndCoActors,width=600]
...
[.thumb]
image::{imagedir}/JamesThompsonFollows.png[JamesThompsonFollows,width=500]
...
[.thumb]
image::{imagedir}/JamesThompson3Hop.png[JamesThompson3Hop,width=400]
...
[.thumb]
image::{imagedir}/JamesThompson1And2Hops.png[JamesThompson1And2Hops,width=500]
...
[.thumb]
image::{imagedir}/JamesThompsonAllHops.png[JamesThompsonAllHops,width=500]
...
[.thumb]
image::{imagedir}/OptionalMatch.png[OptionalMatch,width=600]
