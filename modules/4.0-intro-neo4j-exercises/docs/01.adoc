...
. Click the _Run_ button image:{imagedir}/run-button.png[] in order to execute the code.
...
[.thumb]
image::{imagedir}/ReturnAllNode.png[ReturnAllNode,width=250]
...
[.thumb]
image::{imagedir}/call_db.schema.png[call_db.schema,width=600]
...
[.thumb]
image::{imagedir}/PersonNodes.png[PersonNodes,width=600]
...
[.thumb]
image::{imagedir}/MovieNodes.png[MovieNodes,width=600]
