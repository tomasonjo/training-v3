...
[.thumb]
image::{imagedir}/FiveMovies.png[FiveMovies,width=600]
...
[.thumb]
image::{imagedir}/AtMost3MoviesPerActor.png[AtMost3MoviesPerActor,width=600]
...
[.thumb]
image::{imagedir}/TopDirectorsAndReviewers.png[TopDirectorsAndReviewers,width=600]
...
The result returned should be:
[.thumb]
image::{imagedir}/ActorsWithMoreThan5Movies1.png[ActorsWithMoreThan5Movies1,width=600]
...
[.thumb]
image::{imagedir}/ActorsWithMoreThan5Movies2.png[ActorsWithMoreThan5Movies2,width=500]
