...
image:{imagedir}/InitialDatabase.png[InitialDatabase,width=150]
...
[.thumb]
image::{imagedir}/CreateForrestGump.png[CreateForrestGump,width=500]
...
[.thumb]
image::{imagedir}/RetrieveForrestGump.png[RetrieveForrestGump,width=400]
...
[.thumb]
image::{imagedir}/CreateRobinWright.png[CreateRobinWright,width=600]
...
[.thumb]
image::{imagedir}/RetrieveRobinWright.png[RetrieveRobinWright,width=600]
...
[.thumb]
image::{imagedir}/AddOlderMovieLabel.png[AddOlderMovieLabel,width=600]
...
[.thumb]
image::{imagedir}/RetrieveOlderMovies.png[RetrieveOlderMovies,width=600]
...
[.thumb]
image::{imagedir}/AddFemaleLabel.png[AddFemaleLabel,width=500]
...
[.thumb]
image::{imagedir}/RetrieveFemales.png[RetrieveFemales,width=600]
...
[.thumb]
image::{imagedir}/RemoveFemales.png[RemoveFemales,width=500]
...
[.thumb]
image::{imagedir}/SchemaAfterLabelAddition.png[SchemaAfterLabelAddition,width=600]
...
[.thumb]
image::{imagedir}/AddingPropertiesForrestGump.png[AddingPropertiesForrestGump,width=500]
...
[.thumb]
image::{imagedir}/RetrieveForrestGump2.png[RetrieveForrestGump2,width=600]
...
[.thumb]
image::{imagedir}/SetRobinWrightProperties.png[SetRobinWrightProperties,width=500]
...
[.thumb]
image::{imagedir}/RetrieveRobinWrightWithProperties.png[RetrieveRobinWrightWithProperties,width=600]
...
[.thumb]
image::{imagedir}/RemoveLengthInMinutes.png[RemoveLengthInMinutes,width=500]
...
[.thumb]
image::{imagedir}/DeletedLengthInMinutesQuery.png[DeletedLengthInMinutesQuery,width=600]
...
[.thumb]
image::{imagedir}/RemovedBirthPlace.png[RemovedBirthPlace,width=500]
...
[.thumb]
image::{imagedir}/UpdatedRobinWright.png[UpdatedRobinWright,width=600]
