...
[.thumb]
image::TomCruiseMovies.png[TomCruiseMovies,width=500]
...
[.thumb]
image::SeventiesActors.png[SeventiesActors,width=700]
...
[.thumb]
image::MatrixYoungerActors.png[MatrixYoungerActors,width=500]
...
[.thumb]
image::MatchWritersWhere.png[MatchWritersWhere,width=800]
...
[.thumb]
image::NoYearBorn.png[NoYearBorn,width=600]
...
[.thumb]
image::RelationshipsWithRatings.png[RelationshipsWithRatings,width=800]
...
[.thumb]
image::ProducersThatAreNotDirectors.png[ProducersThatAreNotDirectors,width=500]
...
[.thumb]
image::MoviesInList.png[MoviesInList,width=500]
