...
image::{imagedir}/AfterExercise11.png[AfterExercise11,width=150]
...
[.thumb]
image::{imagedir}/CreateForrestGump2.png[CreateForrestGump2,width=600]
...
[.thumb]
image::{imagedir}/MergeForrestGump.png[MergeForrestGump,width=600]
...
[.thumb]
image::{imagedir}/MergeProduction.png[MergeProduction,width=600]
...
[.thumb]
image::{imagedir}/AllForrestGumps.png[AllForrestGumps,width=600]
...
[.thumb]
image::{imagedir}/AddCompany.png[AddCompany,width=600]
...
[.thumb]
image::{imagedir}/AddOlderMovieLabelToForrestGump.png[AddOlderMovieLabelToForrestGump,width=600]
...
[.thumb]
image::{imagedir}/MergeNodesAndRelationships.png[MergeNodesAndRelationships,width=500]
...
[.thumb]
image::{imagedir}/MergeNodesAndRelationships2.png[MergeNodesAndRelationships2,width=500]
...
[.thumb]
image::{imagedir}/FindPersonNodeBeforeDelete.png[FindPersonNodeBeforeDelete,width=600]
...
[.thumb]
image::{imagedir}/DeletedExtraPerson.png[DeletedExtraPerson,width=500]
...
[.thumb]
image::{imagedir}/ForrestGumpToDelete.png[ForrestGumpToDelete,width=600]
...
[.thumb]
image::{imagedir}/DeletedExtraForrestGump.png[DeletedExtraForrestGump,width=500]
...
[.thumb]
image::{imagedir}/AddDirectedToForrestGump.png[AddDirectedToForrestGump,width=500]
...
[.thumb]
image::{imagedir}/ActedInForrestGump.png[ActedInForrestGump,width=500]
...
[.thumb]
image::{imagedir}/SetActedRoles.png[SetActedRoles,width=500]
...
[.thumb]
image::{imagedir}/VerifyRoleUpdates.png[VerifyRoleUpdates,width=600]
