...
image::{imagedir}/AfterExercise10.png[AfterExercise10,width=150]
...
[.thumb]
image::{imagedir}/DeleteHELPED.png[DeleteHELPED,width=500]
...
[.thumb]
image::{imagedir}/ConfirmDeleteHELPED.png[ConfirmDeleteHELPED,width=500]
...
[.thumb]
image::{imagedir}/QueryForrestGump.png[QueryForrestGump,width=500]
...
[.thumb]
image::{imagedir}/DeleteNodeFailed.png[DeleteNodeFailed,width=600]
...
[.thumb]
image::{imagedir}/DetachDelete.png[DetachDelete,width=500]
...
[.thumb]
image::{imagedir}/NoForrestGump.png[NoForrestGump,width=500]
