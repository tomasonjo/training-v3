...
image::{imagedir}/AfterExercise12.png[AfterExercise12,width=150]
...
[.thumb]
image::{imagedir}/CreatePersonNameUnique.png[CreatePersonNameUnique,width=400]
...
[.thumb]
image::{imagedir}/CreateTomHanksFailed.png[CreateTomHanksFailed,width=500]
...
[.thumb]
image::{imagedir}/CreateBornExistsConstraintFailed.png[CreateBornExistsConstraintFailed,width=500]
...
[.thumb]
image::{imagedir}/AddBornProperty.png[AddBornProperty,width=500]
...
[.thumb]
image::{imagedir}/AddBornExistsConstraint.png[AddBornExistsConstraint,width=500]
...
[.thumb]
image::{imagedir}/CannotAddWithoutBorn.png[CannotAddWithoutBorn,width=500]
...
[.thumb]
image::{imagedir}/CreateRolesConstraintExists.png[CreateRolesConstraintExists,width=500]
...
[.thumb]
image::{imagedir}/CannotCreateActedInwithoutRoles.png[CannotCreateActedInwithoutRoles,width=600]
...
[.thumb]
image::{imagedir}/AddNodeKey.png[AddNodeKey,width=500]
...
[.thumb]
image::{imagedir}/AddedBackToTheFuture1985.png[AddedBackToTheFuture1985,width=500]
...
[.thumb]
image::{imagedir}/AddedBackToTheFuture2018.png[AddedBackToTheFuture2018,width=500]
...
[.thumb]
image::{imagedir}/AddBackToFutureFailed.png[AddBackToFutureFailed,width=500]
...
[.thumb]
image::{imagedir}/listConstraints.png[listConstraints,width=600]
...
[.thumb]
image::{imagedir}/dropConstraintRoles.png[dropConstraintRoles,width=500]
