...
image::AfterExercise9.png[AfterExercise9,width=300]
...
[.thumb]
image::CreateThreeRelationships.png[CreateThreeRelationships,width=500]
...
[.thumb]
image::AddDirectedRelationship.png[AddDirectedRelationship,width=500]
...
[.thumb]
image::SetPropertiesUsingCase.png[SetPropertiesUsingCase,width=500]
...
[.thumb]
image::PropertyKeys-research.png[PropertyKeys-research,width=800]
...
[.thumb]
image::HELPEDProperties.png[HELPEDProperties,width=600]
...
[.thumb]
image::RemoveResearchProperty.png[RemoveResearchProperty,width=500]
...
[.thumb]
image::GarySiniseRoleUpdate.png[GarySiniseRoleUpdate,width=800]
