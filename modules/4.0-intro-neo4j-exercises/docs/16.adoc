...
[.thumb]
image::{imagedir}/LoadActorsToView.png[LoadActorsToView,width=600]
...
[.thumb]
image::{imagedir}/LoadAndFormatActorData.png[LoadAndFormatActorData,width=600]
...
[.thumb]
image::{imagedir}/LoadedActors.png[LoadedActors,width=600]
...
[.thumb]
image::{imagedir}/LoadMoviesToView.png[LoadMoviesToView,width=600]
...
[.thumb]
image::{imagedir}/LoadAndFormatMovies.png[LoadAndFormatMovies,width=600]
...
[.thumb]
image::{imagedir}/LoadedMovies.png[LoadedMovies,width=600]
...
[.thumb]
image::{imagedir}/LoadRolesToView.png[LoadRolesToView,width=500]
...
[.thumb]
image::{imagedir}/LoadAndFormatRoles.png[LoadAndFormatRoles,width=600]
...
[.thumb]
image::{imagedir}/LoadedRoles.png[LoadedRoles,width=500]
