...
[.thumb]
image::MoviesReleased2003_Table.png[MoviesReleased2003_Table,width=600]
...
[.thumb]
image::call_db.PropertyKeys.png[call_db.PropertyKeys,width=400]
...
[.thumb]
image::UsingAliases.png[UsingAliases,width=500]
